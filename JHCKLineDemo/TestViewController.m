...
- (void)viewDidLoad {
    ...
    [JHCKLineStateManager sharedManager].isFlashKLine = YES;
    self.view.backgroundColor = JHCKLineColors_bgColor;
    
    _pair = @"BTC_USDT";
    _count = 0;
    
    [JHCKLineStateManager sharedManager].flashKLineView = self.klineView;
...
//    self.view.backgroundColor = !isThemeWhite ? [UIColor whiteColor] : JHCKLineColors_bgColor;
    ...
    [JHCKLineStateManager sharedManager].flashMainState = (JHCKLineMainState)arc4random()%3;
}

- (void)timeButtonAction:(UIButton *)button
{
//    BOOL isTimeLine = [JHCKLineStateManager sharedManager].isTimeLineForFlash;
//    [JHCKLineStateManager sharedManager].isTimeLineForFlash = !isTimeLine;
    
    [JHCKLineStateManager sharedManager].flashSecondaryState = (JHCKLineSecondaryState)arc4random()%5;
}
